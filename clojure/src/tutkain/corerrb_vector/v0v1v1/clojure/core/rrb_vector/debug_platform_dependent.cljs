(ns tutkain.corerrb-vector.v0v1v1.clojure.core.rrb-vector.debug-platform-dependent
  (:require [tutkain.corerrb-vector.v0v1v1.clojure.core.rrb-vector.rrbt :as rrbt]
            [tutkain.corerrb-vector.v0v1v1.clojure.core.rrb-vector.nodes :refer [regular? node-ranges]]
...
(defn persistent-vector? [x]
  (or (instance? cljs.core/PersistentVector x)
      ...
      (instance? tutkain.corerrb-vector.v0v1v1.clojure.core.rrb-vector.rrbt/Vector x)))

(defn transient-vector? [x]
  (or (instance? cljs.core/TransientVector x)
      (instance? tutkain.corerrb-vector.v0v1v1.clojure.core.rrb-vector.rrbt/Transient x)))
...
(defn dbg-tailoff [v]
  (cond
    ...
    (or (instance? tutkain.corerrb-vector.v0v1v1.clojure.core.rrb-vector.rrbt/Vector v)
        (instance? tutkain.corerrb-vector.v0v1v1.clojure.core.rrb-vector.rrbt/Transient v))
    (rrbt/-tail-offset v)
