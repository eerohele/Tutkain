...
class TestOpenRoundCommand(ViewTestCase):
    def test_find_next_element(self):
        ...
        self.assertEquals(paredit.find_next_element(self.view, 0), Region(0, 4))
        self.set_view_content('<abc>')
        self.assertEquals(paredit.find_next_element(self.view, 0), Region(0, 5))
        self.set_view_content('=abc=')
        self.assertEquals(paredit.find_next_element(self.view, 0), Region(0, 5))
        self.set_view_content('+abc+')
        self.assertEquals(paredit.find_next_element(self.view, 0), Region(0, 5))
        ...
        self.assertEquals(paredit.find_next_element(self.view, 0), Region(0, 3))
    ...
    def test_find_previous_element(self):
        ...
        self.assertEquals(paredit.find_previous_element(self.view, 4), Region(0, 4))
        self.set_view_content('<abc>')
        self.assertEquals(paredit.find_previous_element(self.view, 5), Region(0, 5))
        self.set_view_content('=abc=')
        self.assertEquals(paredit.find_previous_element(self.view, 5), Region(0, 5))
        self.set_view_content('+abc+')
        self.assertEquals(paredit.find_previous_element(self.view, 5), Region(0, 5))
        ...
        self.assertEquals(paredit.find_previous_element(self.view, 5), Region(0, 5))
        self.set_view_content('äöå')
        self.assertEquals(paredit.find_previous_element(self.view, 3), Region(0, 3))
